...
#include "camera_AE_PLineTable_c2590mipiraw.h"
#include "camera_info_c2590mipiraw.h"
...
{{
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            5827500, -2402500, -867500, -1635000, 5030000, -835000, -1440000, -2472500, 6477500
        },
        {  // i4P10[9]
            2887818, -4010423, 1128355, -213851, -628460, 824499, 664762, -639267, -36995
        },
        {  // i4P01[9]
            2343702, -2476631, 134791, -580862, 422301, 144763, -106359, -815449, 918084
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    287,    // PCloudyRightBound
                    112,    // PCloudyLeftBound
                    -40,    // PCloudyUpperBound
                    -187    // PCloudyLowerBound
                },
                // Shade
                {
                    387,    // PShadeRightBound
                    112,    // PShadeLeftBound
                    -40,    // PShadeUpperBound
                    -187    // PShadeLowerBound
                },
                // Twilight
                {
                    -64,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    -114,    // PWFluoRightBound
                    -314,    // PWFluoLeftBound
                    -60,    // PWFluoUpperBound
                    -262    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -114,    // PIncaRightBound
            ...
            // CCT estimation
            {
                ...
                {
                -430,    // i4RotatedXCoordinate[0]
                -346,    // i4RotatedXCoordinate[1]
                -191,    // i4RotatedXCoordinate[2]
            ...
            {
                {
                    {512, 512, 400}, {512, 512, 400}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                ...
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 530}, {512, 512, 530}, {512, 512, 530}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                }, // CWF
                {
                    {512, 480, 460}, {512, 480, 460}, {512, 490, 460}, {512, 500, 480}, {500, 500, 520}, {500, 512, 520}, {512, 512, 507}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {520, 512, 535}, {520, 512, 535}, {520, 512, 535}, {520, 512, 535}, {520, 512, 535}, {512, 512, 535}, {502, 512, 512}, {502, 512, 512}, {502, 512, 512}
                }, // DAYLIGHT
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
