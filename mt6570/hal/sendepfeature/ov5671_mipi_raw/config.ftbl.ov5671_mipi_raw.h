    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "1600x1200",    "1920x1080",	"1920x1088",    "2048x1536",    "2560x1440",    "2560x1920",    "2880x1728",    
                "2624x1968",  // This is the max picture size, ratio is 4:3, which is the nearly to the max preview size ratio
            )
        ), 
    )
#endif
